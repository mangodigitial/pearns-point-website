...
export default function PlotAndPlanPage() {
  return (
    <>
      {/* ── PAGE HERO ── */}
      <PageHero
        backgroundImage="https://images.unsplash.com/photo-1600607687939-ce8a6c25118c?w=1920&q=85"
        eyebrow="Turnkey Luxury"
        title='Plot and <em>Plan</em>'
        subtitle="For the first time, Pearns Point offers pre-designed luxury villas at a final price — giving you simplicity, peace of mind, and a home crafted by world-class architects."
      />
        ...
        <div className="max-w-content mx-auto grid grid-cols-2 gap-[100px] items-center max-lg:grid-cols-1 max-lg:gap-[60px]">
          ...
          <ScrollReveal>
            ...
            <h2 className="font-display text-[clamp(2rem,4vw,3.2rem)] font-normal leading-[1.2] text-navy mb-5">
              Your Dream Home,<br /><em className="font-light italic">Delivered</em>
            </h2>
          ...
          <ScrollReveal className="max-w-[620px] mx-auto">
            <div className="relative pl-[60px] max-sm:pl-12">
              ...
              {timelineSteps.map((step, i) => (
                <motion.div
                  key={i}
                  className={`relative pl-10 max-sm:pl-8 ${i < timelineSteps.length - 1 ? 'pb-[60px]' : ''}`}
      ...
      <section className="py-20 px-[60px] max-lg:px-7 bg-navy text-center">
        <ScrollReveal className="max-w-[800px] mx-auto">
          ...
          <h2 className="font-display text-[clamp(1.6rem,3vw,2.4rem)] font-normal text-white leading-[1.3] mb-2">
            Turnkey Villas<br /><em className="font-light italic">Starting From</em>
          </h2>
